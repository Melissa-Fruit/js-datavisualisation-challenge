  ...
  function doAjaxRequest(func_name, args, target) {
    ...
    try {
      ...
      if (location.hostname === "localhost") {
        alert(
          'Your browser blocks XMLHttpRequest to "localhost", try using a real hostname for development/testing.'
        );
      }
      throw e;
    }
    ...
    x.onreadystatechange = function () {
      ...
      debug(
        "received (" + x.status + " " + x.statusText + ") " + x.responseText
      );
      ...
      if (typeof target === "function") {
        ...
        alert(
          "Bad target for sajax_do_call: not a function or object: " + target
        );
      }
    };
